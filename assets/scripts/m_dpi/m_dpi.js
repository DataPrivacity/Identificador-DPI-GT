...
function mostrarResultado({ departamento_codigo, departamento_nombre, municipio_codigo, municipio_nombre }){
    $inputDepartamento.dataset.valorDepartamento = `${departamento_codigo}`;
    $inputDepartamento.value = `${departamento_nombre}`;
    $inputMunicipio.dataset.valorMunicipio = `${municipio_codigo}`;
    $inputMunicipio.value = `${municipio_nombre}`;
}


function limpiarResultado() {
    $inputDepartamento.dataset.valorDepartamento = "";
    $inputDepartamento.value = "";
    $inputMunicipio.dataset.valorMunicipio = "";
